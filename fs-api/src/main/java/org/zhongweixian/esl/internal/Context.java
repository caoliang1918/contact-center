...
import static org.zhongweixian.esl.internal.IModEslApi.EventFormat.PLAIN;
...
public class Context implements IModEslApi {
     ...
     * server.
     * <p/>
     * The outcome of the command from the server is returned in an {@link org.zhongweixian.esl.transport.message.EslMessage} object.
     *
     * @param command a mod_event_socket command to send
     * @return an {@link org.zhongweixian.esl.transport.message.EslMessage} containing command results
     */
     ...
     * @return a {@link org.zhongweixian.esl.transport.CommandResponse} with the server's response.
     */
    @Override
