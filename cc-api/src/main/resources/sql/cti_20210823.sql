...
CREATE TABLE `cc_company` (
  ...
  `secret_type` int(11) NOT NULL DEFAULT '1' COMMENT '坐席密码等级',
...
-- ----------------------------
BEGIN;
INSERT INTO `cc_company` VALUES (1, 1604503580, 1604503580, 'test企业', '', 0, 'test', 'test', '18612983191', 1, 0, 1, 1, 1, '', 50, 5000, 20, 1000, 0, 0, 0, 0, 0, 'http://192.168.177.183:8709/push/forcePush/pushTest', '', '', '', '', '', 1);
INSERT INTO `cc_company` VALUES (2, 0, 1619796030, '20210430-delLwqXnW', '', 1, 'test2', '曹亮', '', 0, 0, 0, 1, 1, 'djJHDuy34r87du34', 50, 50, 10, 1000, 0, 0, 0, 0, 0, '', '', '', '', '', '', 0);
INSERT INTO `cc_company` VALUES (15, 0, 1619797353, 'aaaa-delcSJeGY', '', 0, 'acscwe-delIqjPqn', '', '', 0, 0, 0, 1, 1, '', 50, 50, 10, 1000, 0, 0, 0, 0, 0, '', '', '', '', '', '', 0);
INSERT INTO `cc_company` VALUES (16, 0, 0, 'aaaa', '', 0, 'acscwe', '', '', 0, 0, 0, 1, 1, '', 50, 50, 10, 1000, 0, 0, 0, 0, 0, '', '', '', '', '', '', 1);
COMMIT;
...
CREATE TABLE `cc_group` (
  ...
  `record_type` int(11) NOT NULL DEFAULT '1' COMMENT '1:振铃录音,2:接通录音',
  `level_value` int(11) NOT NULL DEFAULT '1' COMMENT '技能组优先级',
  `tts_engine` bigint(20) NOT NULL DEFAULT '0' COMMENT 'tts引擎id',
...
CREATE TABLE `cc_overflow_front` (
  ...
  `front_type` int(11) NOT NULL DEFAULT '1' COMMENT '1:队列长度; 2:队列等待最大时长; 3:呼损率',
  `compare_condition` int(11) NOT NULL DEFAULT '0' COMMENT '0:全部; 1:小于或等于; 2:等于; 3:大于或等于; 4:大于',
  `rank_value_start` int(11) NOT NULL DEFAULT '0',
  `rank_value` int(11) NOT NULL DEFAULT '0' COMMENT '符号条件值',
  `status` int(11) NOT NULL DEFAULT '1' COMMENT '状态',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COMMENT='溢出策略前置条件';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='话单推送记录表';
