...
-- ----------------------------
BEGIN;
INSERT INTO `cc_company` (`id`, `cts`, `uts`, `name`, `id_path`, `pid`, `company_code`, `gmt`, `contact`, `phone`, `balance`, `bill_type`, `pay_type`, `hidden_customer`, `secret_type`, `secret_key`, `ivr_limit`, `agent_limit`, `group_limit`, `group_agent_limit`, `record_storage`, `notify_url`, `ext1`, `ext2`, `ext3`, `ext4`, `ext5`, `status`) VALUES (1, 1604503580, 1604503580, 'test企业', '', 0, 'test', 0, 'test', '13300001234', 1, 0, 1, 1, 1, '0765im6VjutX46iZ', 50, 5000, 20, 1000, 1, 'https://ccdemo.acloudcc.com/push/push/forcePush/pushTest', '', '', '', '', '', 1);
COMMIT;
